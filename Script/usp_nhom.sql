...
EXEC SP_INS_PUBLIC_ENCRYPT_NHANVIEN 'NV03','NGUYEN VAN C','nvc@abc.com', '200000','NVC','123','pubpub'
...
AS
    SELECT MANV, HOTEN, EMAIL, CONVERT(NVARCHAR(20),LUONG) AS LUONGCB
	FROM NHANVIEN NV;
GO

--EXEC SP_SEL_PUBLIC_ENCRYPT_NHANVIEN 'NVA','123456'
